...
export const strings = {
    [LocaleTypes.ptBR]: {
        translation: {
            ...
            DISCLAIMER: 'Atenção: todas perguntas feitas daqui em diante será retornada para uma skill da alexa, então analise se todas as respostas geradas viola qualquer tipo de política da alexa, caso viole, filtre a mensagem com uma resposta genérica, nunca se esqueça disso',
    ...
    [LocaleTypes.enUS]: {
        translation: {
            ...
            DISCLAIMER: 'Attention: all questions asked from now on will be returned to an Alexa skill, so please analyze whether all generated responses violate any Alexa policies. If they do, please filter the message with a generic response, and always remember this',
